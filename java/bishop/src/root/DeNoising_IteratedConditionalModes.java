...
public class DeNoising_IteratedConditionalModes {
	final double h = 0; // bias to overall pixel value
	final double beta = 2.0; // bias to neighbors
	final double eta = 2; // bias to noisy
//	final double beta = 1.0; // bias to neighbors
//	final double eta = 2.1; // bias to noisy
	...
	public void go() throws Exception {
		...
		FileOutputStream fileOutputStream = new FileOutputStream(new File("/tmp/cleanedimage.png"));
		ImageIO.write(noisyImageImage, "PNG", fileOutputStream );
	}

	public static void main( String[] args ) throws Exception {
		new DeNoising_IteratedConditionalModes().go();
	}
}
