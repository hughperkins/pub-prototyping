...
public class DeNoising_IteratedConditionalModes2 {
	final double h = 0;
	final double beta = 1.0;
	final double eta = 2.1;
	...
	double calcEnergy( int x, int y, int value ) {
		...
		for( Vector2i direction : Vector2i.directions8 ) {
	...
	public static void main( String[] args ) throws Exception {
		new DeNoising_IteratedConditionalModes2().go();
	}
}
