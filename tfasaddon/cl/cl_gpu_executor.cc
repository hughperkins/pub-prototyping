...
void initialize_cl_gpu_executor() {
  ...
  //             << status.status();
  // }
  std::cout << "initialize_cl_gpu_executor" << std::endl;
...
using StreamExecutorFactory =
    std::function<perftools::gputools::internal::StreamExecutorInterface *(const perftools::gputools::PluginConfig &)>;
...
void init_cl_executor() {
  perftools::gputools::initialize_cl_gpu_executor();
}
